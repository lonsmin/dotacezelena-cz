<template>
  <div
    v-if="isSend"
    id="form"
    class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ha mt1"
  >
  ...
  <div
    v-if="!isSend"
    id="form"
    class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ha mt1"
  >
    <div class="row">
      <div class="form">
        ...
        <div class="row">
          ...
          <div class="input-group">
            <p>
              V případě vyplnění podrobného formuláře, Vás mohu kontaktovat již
              s lépe orientovanou nabídkou přímo pro Vás
            </p>
            ...
            <label for="mainCheckbox" class="checkbox">
              Podrobný formulář</label
            >
          </div>
    ...
    async onSubmit() {
      ...
      try {
        ...
        if (data == "OK") {
          ...
          this.errorMessages =
            'Zaškrtněte prosím políčko "Souhlasím se Zásady..."';
        } else if (data == "Error") {
          this.errorMessages =
            "Vyplňte prosím alespoň e-mail nebo telefonní číslo";
        }
      } catch (error) {
        this.errorMessages = error;
      }
